...
if (isset($_POST['checkoutsuplement'])) {
    ...
    foreach ($_SESSION["keranjangsuplement"] as $id_suplement => $jumlah) {
        ...
        $koneksi->query("INSERT INTO pembelian_suplement (id_pembelian, id_suplement, nama, harga, jumlah, subharga)
            VALUES ('$id_pembelian_barusan', '$id_suplement', '$nama_produk', '$harga_produk', '$jumlah', '$subharga')");
    }
    
    unset($_SESSION["keranjangsuplement"]);
    unset($_SESSION['totalbelanja']);

    echo "<script>alert('Pembelian Sukses');</script>";
    echo "<script>location = 'notasuplement.php?id=$id_pembelian_barusan';</script>";
}
?>
            ...
            <form method="post">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <button class="btn btn-primary" name="checkoutsuplement">Checkout</button>
                    </div>
                </div>
            </form>
        </div>
