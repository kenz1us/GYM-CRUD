...
if (isset($_POST['checkoutmember'])) {
    ...
    foreach ($_SESSION["keranjangmember"] as $id_member => $jumlah) {
        ...
        $koneksi->query("INSERT INTO pembelian_member (id_pembelian, id_member, nama, harga, jumlah, subharga)
            VALUES ('$id_pembelian_barusan', '$id_member', '$nama_produk', '$harga_produk', '$jumlah', '$subharga')");
    }

    unset($_SESSION["keranjangmember"]);
    unset($_SESSION['totalbelanja']);

    echo "<script>alert('Pembelian Sukses');</script>";
    echo "<script>location = 'notamember.php?id=$id_pembelian_barusan';</script>";
}
?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <h3>Ringkasan Belanja</h3>
                            ...
                            <button class="btn btn-primary" name="checkoutmember">Checkout</button>
