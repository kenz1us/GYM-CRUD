...
<head>
    ...
    <title>Product Outfit - GYMShark</title>
    <!-- Favicon-->
    ...
    <section class="py-5">
            ...
            <div class="row gx-4">
                    ...
                    <div class="col text-end">
                        ...
                        <a  href="keranjangoutfit.php" class="btn btn-outline-dark mt-auto">Liat Keranjang</a><br><br>
                    </div>
                </div>
                    ...
                    <?php while($perproduk = $ambil->fetch_assoc()){ ?>
                        <div class="col mb-5">
                            <div class="card h-100">
                                ...
                                <div class="text-center">
                                    <a  style="width: 75%;" href="belioutfit.php?id_outfit=<?php echo $perproduk['id_outfit'];?>" class="btn btn-outline-dark mt-auto">Beli</a>
