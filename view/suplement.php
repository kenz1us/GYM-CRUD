...
<head>
    ...
    <title>Product Suplement - GYMShark</title>
    <!-- Favicon-->
    ...
    <section class="py-5">
            ...
            <div class="row gx-4">
                    ...
                    <div class="col text-end">
                        ...
                        <a  href="keranjangsuplement.php" class="btn btn-outline-dark mt-auto">Liat Keranjang</a><br><br>
                    </div>
                </div>
                        ...
                        <div class="col mb-5">
                            <div class="card h-100">
                                ...
                                <div class="text-center">
                                    ...
                                    <a style="width: 75%;" href="belisuplement.php?id_suplement=<?php echo $perproduk['id_suplement'];?>" class="btn btn-outline-dark mt-auto">Beli</a>
							        <!-- -->
                                </div>
                                </div>
                            </div>
