...
if (isset($_POST['daftarumum'])) {
    ...
    // menyiapkan query
    $sql = "INSERT INTO users_umum (name, username, password, nohp) VALUES (?, ?, ?, ?)";
...
<head>
    ...
    <style>
        ...
        .daftarumum-container h2 {
            margin-bottom: 20px;
        }
        .daftarumum-container input[type="text"],
        .daftarumum-container input[type="password"] {
            margin-bottom: 20px;
        }
        .daftarumum-container input[type="submit"] {
            width: 100%;
        }
    </style>
</head>
<body>
    ...
    session_start();
    ?>
        <div class="daftarumum-container">
            ...
            <form action="" method="post">
                ...
                <input type="submit" class="btn btn-success btn-block" name="daftarumum" value="Daftar" />
